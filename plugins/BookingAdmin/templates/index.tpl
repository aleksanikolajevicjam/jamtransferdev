                ...
                <form id="bookingForm" name="bookingForm" action=""
                    ...
                    <div class="col s12 l2" id=' webyblock' style="display:none">
                        ...
                        <input type="hidden" id="AgentName"
                               name="AgentName" value="0">
                        <input type="hidden" id="DriverID"
                               name="DriverID" value="0">
                        <input type="hidden" id="DriverName"
                               name="DriverName" value="0">
                        <input type="hidden" id="VehicleID"
                               name="VehicleID" value="0">
                        <input type="hidden" id="VehiclesNo"
                               name="VehiclesNo" value="1">
                        <input type="hidden" id="VehicleName"
                               name="VehicleName" value="">
                        <input type="hidden" id="VehicleCapacity"
                               name="VehicleCapacity" value="0">
                        <input type="hidden" id="VehicleImage"
                               name="VehicleImage" value="">
                        <input type="hidden" id="ServiceID"
                               name="ServiceID" value="0">
                        <input type="hidden" id="RouteID"
                               name="RouteID" value="0">
                        <input type="hidden" id="Price"
                               name="Price" value="0">
                        <input type="hidden" id="AgentPrice"
                               name="AgentPrice" value="0">
                        <input type="hidden" id="DriversPrice"
                               name="DriversPrice" value="0">
                        <input type="hidden" id="returnTransfer"
                               name="returnTransfer" value="0">
                        <input type="hidden" id="ToName2"
                               name="ToName2" value="0">
                        <input type="hidden" id="VehicleName2"
                               name="VehicleName2" value="">
                        <input type="hidden" id="api" name="api"
                               value="">

                        <input type="hidden" id="PaxFirstName"
                               name="PaxFirstName" value="{$PaxFirstName}">
                        <input type="hidden" id="PaxSurName"
                               name="PaxSurName" value="{$MPaxLastName}">
                        <input type="hidden" id="PaxTel"
                               name="PaxTel" value="{$PaxTel}">
                        <input type="hidden" id="FlightNo"
                               name="FlightNo" value="{$FlightNo}">
                        <input type="hidden" id="FlightCo"
                               name="FlightCo" value="">
                        <input type="hidden" id="FlightTime"
                               name="FlightTime" value="{$FlightTime}">
                        <input type="hidden" id="DFlightNo"
                               name="DFlightNo" value="{$DFlightNo}">
                        <input type="hidden" id="DFlightCo"
                               name="DFlightCo" value="">
                        <input type="hidden" id="DFlightTime"
                               name="DFlightTime" value="{$DFlightTime}">
                        <input type="hidden" id="RFlightNo"
                               name="RFlightNo" value="{$RFlightNo}">
                        <input type="hidden" id="RFlightCo"
                               name="RFlightCo" value="">
                        <input type="hidden" id="RFlightTime"
                               name="RFlightTime" value="{$RFlightTime}">
                        <input type="hidden" id="RDFlightNo"
                               name="RDFlightNo" value="{$RDFlightNo}">
                        <input type="hidden" id="RDFlightCo"
                               name="RDFlightCo" value="">
                        <input type="hidden" id="RDFlightTime"
                               name="RDFlightTime" value="{$RDFlightTime}">

                        <input id='SPAddressHotel'
                               name='SPAddressHotel' type='hidden'/>
                        <input id='SDAddressHotel'
                               name='SDAddressHotel' type='hidden'/>
                        <input id='RPAddressHotel'
                               name='RPAddressHotel' type='hidden'/>
                        <input id='RDAddressHotel'
                               name='RDAddressHotel' type='hidden'/>
                        <input id='PickupAddress'
                               name='PickupAddress' type='hidden'
                               value="{$PickupAddress}"/>
                        <input id='DropAddress' name='DropAddress'
                               type='hidden' value="{$DropAddress}"/>
                        <input id='RPickupAddress'
                               name='RPickupAddress' type='hidden'
                               value="{$RPickupAddress}"/>
                        <input id='RDropAddress'
                               name='RDropAddress' type='hidden' value="{$RDropAddress}"/>

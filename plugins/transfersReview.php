		...
		<div class="row pad1em" >
			...
			<div class="col-md-1">
				...
				<select id="client" name="client" class="form-control w75">
					...
					<option value="91">Administrator</option> 
			...
			<div class="col-md-2">
				<button type="text"class="submit" name='stype' value='stat'>Stat</button></br>
				<button type="text" class="submit" name='stype' value='list'>List</button>
				<input type="radio" name="lt" value="list1">Pickup Date
				<input type="radio" name="lt" value="list2">Order Date
			</div>	

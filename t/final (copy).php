...
@session_start();
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . '/db/v4_Countries.class.php';    
...
<?/*						
						<div class="col s12  ">
							<div id="CouponData" class="hidden">
								...
								<p>
								    <button class="btn blue-2" id="CouponBtn" 
								            onclick="return CheckCoupon();">
								    <i class="fa fa-checkmark-circle"></i> <?= APPLY_COUPON ?>
								    </button>
								</p>
							</div>
				
							<div id="showNewTotal" class="col s12"></div>
							<br>
							<div class="col s12 l4 offset-l4 center  xblack-text">
								...
								onchange="paymentOptionSelect();" >
									<option value="2"><?= PAY_INVOICE ?></option>
						...
						<div class="col s12  pad1em xxwhite-text">
							<br>
							<h5 class="creditCardPayment center" style="display:none"><?= CARD_HOLDER_DETAILS ?></h5>
							

							<div class="cashPayment col s12 white black-text center xz-depth-2 pad1em"
							 style="display:none">
							 
								<h5 class="cashPayment" style="display:none">
									<i class="fa  fa-mobile large"></i><br><?= CASH_PAYMENT_DETAILS ?></h5>
								<div id="sendPin">
									
									<?= EMAIL_INSTRUCTIONS ?>

									<br>
									<button class="btn blue " onclick="return sendPIN();">
									<?= SEND_PIN ?></button>
								</div>
							...
							<div class="creditCardPayment col s12 l6 offset-l3 white black-text pad1em z-depth-2" 
							style="display:none">
								...
								<div class="form-group">
									...
									<input id="ch_address" name="ch_address" type="text" value=""
									 class="w100" />
								</div>
								<div class="form-group">						
								...
								<div class="form-group">
									...
									<select id="ch_country" name="ch_country"  class="browser-default">
										<option value=""> --- </option>
										<?
										$c = new v4_Countries();
								...
								<div class="form-group">
                                    ...
                                    <input id="ch_phone" name="ch_phone" type="text" class="w100" 
                                    value="<?= $paxMobile?>" />
								</div>
								<div class="form-group">
									<label for="ch_email"><?= EMAIL?> *:</label><br/>
									<input id="ch_email" name="ch_email" type="text" class="w100" 
									value="<?= $paxEmail ?>" />
								</div>
							</div>
						    ...
						    <div class="col s12 l9">
							    <input type="email" id="PaxEmail" name="MPaxEmail"

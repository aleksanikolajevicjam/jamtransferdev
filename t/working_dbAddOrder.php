...
function insertOrder($type='temp') {	
    ...
    if($_SESSION['PaymentOption'] == '1') { // Sve online - provizija
        ...
        $Invoice  = '0.00';   // nema nista ni za invoice
        $paymentStatus = '99';
	...
	// OrdersMaster
		...
		$om->setMInvoiceAmount( $Invoice);
		$om->setMAgentCommision( $AgentCommision);
		...
		$od->setInvoiceAmount( nf($InvoiceDetails) );
		$od->setProvisionAmount( nf($AgentCommisionDetails));

...
// ODE IDE AGENTSKI MAIL ZA REZERVACIJE - FREE FORM?
	...
	if (count($omKeys) == 0) {
		...
		// Upis u bazu
		$OrderKey = '';
		require_once $_SERVER['DOCUMENT_ROOT'] . '/cms/t/dbAddOrderAdmin.php';
		...
		if ($ok) {
			...
			$sent = mail_html('cms@jamtransfer.com', $from_mail, $from_name, $replyto, $mailSubjectPrefix.$subject, $potvrda, $_SERVER['DOCUMENT_ROOT'] .'/cms/pdf/'.$OrderKey.'.pdf');
...
?>
	...
	<a href='/cms/index.php?p=booking' class="btn btn-large grey xcol xs12 l "><i class="fa fa-chevron-circle-left"></i>&nbsp; New booking</a>
	<a href='/cms/index.php?p=transfersList&transfersFilter=order&orderid=<? echo $om->MOrderID; ?>' class="btn btn-large grey xcol xs12 l ">Go to transfer list &nbsp;<i class="fa fa-chevron-circle-right"></i></a>

...
?>
    <form method="post" id="finalForm" name="finalForm" action="index.php?p=agentPayment2"
...
*/?>
                        ...
                        <div class="col s6 l9">
                            <h5><strong><?= nf( toCurrency(s('Price')) ) . ' ' . s('Currency') ?> - <?= nf( toCurrency(s('Price')*($_SESSION['Provision'])/100) ) . ' ' . s('Currency') ?> (<?= PROVISION ?>)</strong></h5>
							<p style='display:none'><?= s('Price')*s('Provision')/100 ?></p>
                        </div>
                        ...
                        <div class="col s12 l6 offset-l3">
                            <div class="col s12 center  xblack-text">
                                ...
                                onchange="paymentOptionSelect();" >
                                    ...
                                    if($userData['AcceptedPayment'] == '13') {
                            ...
                            <div class="col s12 center  xblack-text">
                                <label for="PaxEmail">CONTACT EMAIL *</label>

<? 
	...
	if (isset($_REQUEST['FromID']) && $_REQUEST['FromID']>0) $_SESSION['FromID']=$_REQUEST['FromID'];
	if (isset($_REQUEST['ToID']) && $_REQUEST['FromID']>0) $_SESSION['ToID']=$_REQUEST['ToID'];
       ...
       <div class="container pad1em" style="background-color: rgba(70,79,96,0.75); border:1px solid #000;border-radius:6px;">
            <div class="row">
                ...
                <div class="col s12 xgrey xlighten-3">
                    <br>
                    <form id="bookingForm" name="bookingForm" action="index.php?p=final2" method="POST"  
                    onsubmit="return validateBookingForm();">
                        ...
                        <div class="col s12 l6">
							...
							<input type="text" id="FromName" name="FromName" value="<?= $fromName ?>" class="input-lg" style="width:100%"  placeholder="<?= $SEARCH_PLACEHOLDER ?>"
								autocomplete="off">
							<span id="fromLoading" style='color:white' class="small">Search (min. 3 chars)...</span>

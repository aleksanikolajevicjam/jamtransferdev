...
?>
    <form method="post" id="finalForm" name="finalForm" action="index.php?p=final2"
    ...
    <br>
        ...
        <div class="container pad1em row" style="background-color: rgba(70,79,96,0.75);">
            ...
            <div class="row">
				...
				<div id="selectExtras" class="col-md-6 grey lighten-4 pad1em z-depth-1 ">
					<? require_once $_SERVER['DOCUMENT_ROOT'].'/cms/t/para_extras.php'; ?>
				</div>
				<!-- Extras row -->
			</div>
			...
			<div class="row blue xdarken-3 white-text xl z-depth-2 center">
				<div  class="col-md-6">Total price:
					<span class="grandTotal"><?= nf(toCurrency(s('Price'))) ?></span>
				</div>
        ...
        <input  type="hidden" id="DriversPrice" name="DriversPrice" value="<?= number_format(s('DriversPrice'), 2, '.', '') ?>">
			...
			<input id='TransferCost' name='TransferCost' type='hidden' value=""/>
			<input id='RTransferCost' name='RTransferCost' type='hidden' value=""/>

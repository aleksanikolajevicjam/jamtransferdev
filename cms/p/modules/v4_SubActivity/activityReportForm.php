...
$q = 'SELECT DISTINCT Expense FROM v4_SubActivitiy WHERE Approved<9 AND OwnerID = '.$_SESSION["OwnerID"].' ORDER BY Expense ASC';
$r = $db->RunQuery($q);
$expenseArr = array();
	...
	<form action="index.php?p=expensesReport" method="POST">
		...
		<div class='row'>
			...
			<div class="col-md-6">			
				...
				<div style="height:2em">
					<input type="checkbox" name="approved" style="height: 0.8em" value="" checked> Approved
				</div>
			</div>
		</div>

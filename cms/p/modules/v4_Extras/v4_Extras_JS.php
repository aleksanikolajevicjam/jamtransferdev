...
<script type="text/javascript">
	...
	function all_v4_Extras() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_Extras/v4_Extras_All.php?where='+where+
	...
	function one_v4_Extras(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_Extras/v4_Extras_One.php?ID='+id;
	...
	function editSavev4_Extras(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_Extras/'+

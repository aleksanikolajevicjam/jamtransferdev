...
<div class="container">
	...
	<form action="index.php?p=subexpenses" method="POST">
		...
		<div class='row'>
			...
			<div class="col-md-6">			
				<div style="height:2em">
					<input type="checkbox" name="card" style="height: 0.8em" value="1" checked> Cash
				</div>

				<div style="height:2em">
					<input type="checkbox" name="approved" style="height: 0.8em" value="1" checked> Approved
				</div>
				
				
				<div style="height:2em">
					<input type="checkbox" name="download" style="height: 0.8em" value="1" > Download documents
				</div>
			</div>
		</div>

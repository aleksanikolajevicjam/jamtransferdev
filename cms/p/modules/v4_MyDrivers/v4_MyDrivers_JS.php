...
<script type="text/javascript">
	...
	function all_v4_MyDrivers() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_MyDrivers/v4_MyDrivers_All.php?where='+where+
	...
	function one_v4_MyDrivers(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_MyDrivers/v4_MyDrivers_One.php?DriverID='+id;
	...
	function editSavev4_MyDrivers(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_MyDrivers/'+

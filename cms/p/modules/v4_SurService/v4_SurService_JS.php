...
<script type="text/javascript">
	...
	function all_v4_SurService() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_SurService/v4_SurService_All.php?where='+where+
	...
	function one_v4_SurService(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_SurService/v4_SurService_One.php?ID='+id;

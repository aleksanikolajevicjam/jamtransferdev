...
?>
<div class="container">
	<h1>Specially Priced Dates <?= $titleAddOn ?></h1>
	<a class="btn btn-primary btn-xs" href="index.php?p=newSpecial"><?= NNEW ?></a>
	<br><br>
	...
	<!-- EXAMPLE !!!
		<div class="col-md-2">
			...
			<select id="UserLevel" class="w75" onchange="all_v4_SpecialDatesFilter();">
	...
	-->
		<div class="col-md-3">
			<i class="fa fa-eye"></i>
			<select id="length" class="w75" onchange="all_v4_SpecialDatesFilter();">
		...
		<div class="col-md-3">
			...
			<input type="text" id="Search" class=" w75" onkeyup="all_v4_SpecialDatesFilter();">
		</div>

		<div class="col-md-3">
			
			<i class="fa fa-sort-amount-asc"></i> 
			<select name="sortOrder" id="sortOrder" onchange="all_v4_SpecialDatesFilter();">
	...
	<div id="show_v4_SpecialDates"><?= THERE_ARE_NO . DATA ?></div>
	...
	<? 
		...
		// koristi handlebars
		//require_once $modulesPath .'/v4_SpecialDates/v4_SpecialDatesListTemplate.'.$_SESSION['GroupProfile'].'.php'; 
		//require_once $modulesPath .'/v4_SpecialDates/v4_SpecialDatesEditForm.'.$_SESSION['GroupProfile'].'.php'; 
		require_once $modulesPath .'/v4_SpecialDates/v4_SpecialDatesListTemplate.Driver.php'; 
		require_once $modulesPath .'/v4_SpecialDates/v4_SpecialDatesEditForm.Driver.php'; 
...
<? require_once ROOTPATH.'/p/modules/v4_SpecialDates/v4_SpecialDates_JS.php' ?>	

<script type="text/javascript">
	$(document).ready(function(){
		$(".datepicker").pickadate({format:'yyyy-mm-dd'});
		all_v4_SpecialDates(); // definirano u v4_SpecialDates_JS.php
	});

	function all_v4_SpecialDatesFilter() {
		all_v4_SpecialDates(); // definirano u v4_SpecialDates_JS.php
	}
</script>	

...
session_start();
	...
	# Details  red
	$dbk = $db->getKeysBy('ServiceID','asc','WHERE ServiceID = ' . $_REQUEST['ServiceID']);

	# Details  red
	$db->getRow($dbk[0]);
	
	// novo pravilo
	if($db->getServiceID() == $_REQUEST['ServiceID']) {
	...
	<div class="box-body ">
		<div class="row">
			<div class="col-md-12">
						...
						<input type="hidden" name="ServiceID" id="ServiceID" class="w100" value="<?= $db->getServiceID();?>" readonly>
	...
	<div class="box-body ">
        <div class="row">
			<div class="col-md-12">
						...
						<input type="hidden" name="ServiceID" id="ServiceID" class="w100" value="<?= $_REQUEST['ServiceID']?>" readonly>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="S4End" id="S5End" class="w100 datepicker" value="<?= $sg->getS5End(); ?>">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-9">
						<input type="text" name="S6End" id="S4End" class="w100 datepicker" value="<?= $sg->getS6End(); ?>">
					</div>
				</div>

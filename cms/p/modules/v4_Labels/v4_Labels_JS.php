...
<script type="text/javascript">
	...
	function all_v4_Labels() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_Labels/v4_Labels_All.php?where='+where+
	...
	function one_v4_Labels(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_Labels/v4_Labels_One.php?LabelID='+id;
	...
	function editSavev4_Labels(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_Labels/'+

...
require_once '../../../../db/v4_Labels.class.php';
...
$dbTotalRecords = $db->getKeysBy('Label ASC', '',$DB_Where);

# test za LIMIT - trebalo bi ga iskoristiti za pagination! 'asc' . ' LIMIT 0,50'
$dbk = $db->getKeysBy('Label ' . $sortOrder, '' . $limit , $DB_Where);

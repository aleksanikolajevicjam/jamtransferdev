...
//require_once '../../../headerScripts.php';
	...
	# Details  red
	$dbk = $db->getKeysBy('VehicleID','asc','WHERE VehicleID = ' . $_REQUEST['VehicleID']);

	# Details  red
	$db->getRow($dbk[0]);
	
	// novo pravilo
	if($db->getVehicleID() == $_REQUEST['VehicleID']) {
...
*/
?>	
<form id="v4_SurVehicleEditForm" class="form " enctype="multipart/form-data" method="post" onsubmit="return false;">	
	<div class="box-body ">
        <div class="row">
			<div class="col-md-12">
						...
						<input type="hidden" name="VehicleID" id="VehicleID" class="w100" value="<?= $db->getVehicleID();?>" readonly>
	...
	<div class="box-body ">
        <div class="row">
			<div class="col-md-12">
						...
						<input type="hidden" name="VehicleID" id="VehicleID" class="w100" value="<?= $_REQUEST['VehicleID']?>" readonly>

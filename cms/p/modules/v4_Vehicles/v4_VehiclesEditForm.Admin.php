...
*/?>
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<form name="form" action="" method="POST" enctype="multipart/form-data">
										...
										onchange="return ajaxFileUpload('1','save');">
										<br>
									...
									<button id="imgDel" class="btn btn-xs btn-default" 
										onclick="ajaxFileUpload('1','delete');">
										<?= DELETE_IMAGE ?>
									</button>										
								</div>
								...
								<div class="col-md-3">
									...
									<form name="form" action="" method="POST" enctype="multipart/form-data">
										...
										onchange="return ajaxFileUpload('2','save');">
										<br>
									...
									<button id="imgDel" class="btn btn-xs btn-default" 
										onclick="ajaxFileUpload('2','delete');">
										<?= DELETE_IMAGE ?>
									</button>									
								</div>
								...
								<div class="col-md-3">
									...
									<form name="form" action="" method="POST" enctype="multipart/form-data">
										...
										onchange="return ajaxFileUpload('3','save');">
										<br>
									...
									<button id="imgDel" class="btn btn-xs btn-default" 
										onclick="ajaxFileUpload('3','delete');">
										<?= DELETE_IMAGE ?>
									</button>										
								</div>
								...
								<div class="col-md-3">
									...
									<form name="form" action="" method="POST" enctype="multipart/form-data">
										...
										onchange="return ajaxFileUpload('4','save');">
										<br>
									...
									<button id="imgDel" class="btn btn-xs btn-default" 
										onclick="ajaxFileUpload('4','delete');">
										<?= DELETE_IMAGE ?>
									</button>										
								</div>
							</div>
	...
	<script>
		...
		function ajaxFileUpload(vehicleImageNo,operation)
		{
			$("#loading")
			.ajaxStart(function(){
				$(this).show();
			...
			(
				{
					url: 	window.root + 
							...
							'&ImageNo='+vehicleImageNo+'&operation='+operation,
					secureuri:false,

...
error_reporting(E_PARSE);
	...
	if(!isset($_REQUEST['DriverRouteID']) or !isset($_REQUEST['OwnerID'])) {
		$out = array(
	...
	$dbk = $db->getKeysBy('DriverRouteID','asc','WHERE DriverRouteID='.$_REQUEST['DriverRouteID'].' AND OwnerID='.$_REQUEST['OwnerID']);

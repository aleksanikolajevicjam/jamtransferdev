...
<div class="container">
	...
	<? 
		...
		// koristi handlebars
		if($_SESSION['AuthUserID'] == 1956){
			require_once $modulesPath .'/v4_Invoices/v4_InvoicesListTemplate.'.$_SESSION['GroupProfile'].'-1.php'; 
			require_once $modulesPath .'/v4_Invoices/v4_InvoicesEditForm.'.$_SESSION['GroupProfile'].'-1.php';
		} else {

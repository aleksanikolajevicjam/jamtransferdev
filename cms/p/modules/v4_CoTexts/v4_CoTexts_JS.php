...
<script type="text/javascript">
	...
	function all_v4_CoTexts() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_CoTexts/v4_CoTexts_All.php?where='+where+
	...
	function one_v4_CoTexts(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_CoTexts/v4_CoTexts_One.php?ID='+id;
	...
	function editSavev4_CoTexts(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_CoTexts/'+

...
if(isset($_REQUEST['Submit']) and $_REQUEST['Submit'] == '1') {
	...
	while($o = $w->fetch_object()) {
		...
		echo '<a class="btn white lighten-2" href="index.php?p=agentsBalance&pm=6&driverid='.$user['AuthUserID'].
...
?>
	...
	<form action="index.php?p=agentsWTransfers2" method="post">
		<div class="row">
			<div class="col-md-12">
				<br>
				<h2>New Agent Invoice2</h2>
				<br>
			</div>
		</div>

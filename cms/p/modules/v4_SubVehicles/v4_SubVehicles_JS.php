...
<script type="text/javascript">
	...
	function all_v4_SubVehicles() {
		...
		//
	 	...
	 	var url = window.root + '/cms/p/modules/v4_SubVehicles/v4_SubVehicles_All.php?where='+where+
	...
	function one_v4_SubVehicles(id,inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_SubVehicles/v4_SubVehicles_One.php?VehicleID='+id;
	...
	function editSavev4_SubVehicles(id, inList) { 
		...
		var url = window.root + '/cms/p/modules/v4_SubVehicles/'+

...
if(isset($_REQUEST['user']) and $_REQUEST['user'] != '') {
    if($_REQUEST['user'] == 'lyon') { $OwnerID = '876'; $DriverID = '1957'; }
    if($_REQUEST['user'] == 'nica') { $OwnerID = '843'; $DriverID = '1958'; }
}
...
*/
	...
	echo '<button class="btn btn-default" onclick="return emptyFields()">Empty fields</button>';
    echo '</div><br><br>';
        ...
        if(true) {        
            ...
            foreach( $odk as $nn => $DetailsID ) {
                ...
                if( !empty($od->RouteID) ) {
                    ...
                    $time = new DateTime($od->SubPickupDate . ' ' . $od->SubPickupTime);
                ...
                <div class="row pad4px <?=$colorClass?> noPrint" style="border-top: 1px solid #ccc">
                    ...
                    <div class="col-md-2">
                        ...
                        Invoice: <?= $od->InvoiceAmount ?> EUR<br>
						Receipt: <?= $od->CustomerInvoice ?>  
    ...
    echo '<a class="btn xblue l" href="https://cms.jamtransfer.com/cms/fr/selector.php?user='.$_REQUEST['user'].'">Back</a>&nbsp;&nbsp;';
    
    echo '<a class="btn xgreen l center" href="https://cms.jamtransfer.com/cms/fr/monthlyReport.php?user='.$_REQUEST['user'].
    '&SubDriverID='.$SubDriverID.'&Month='.$Month.'&Year='.$Year.'">Print Report</a>&nbsp;&nbsp;';

    echo '<a class="btn xgreen l center xwhite-text" href="https://cms.jamtransfer.com/cms/fr/transfersReport.php?user='.$_REQUEST['user'].

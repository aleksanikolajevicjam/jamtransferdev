<?
	...
	$q  = " SELECT SUM(ProvisionAmount) AS Provision, SUM(InvoiceAmount+PayLater+PayNow) AS Invoice FROM v4_OrderDetails ";
	$q .= " WHERE UserID = '".$_SESSION['AuthUserID'] ."'";
	$q .= " AND TransferStatus not in (3,9) ";
	...
	$lastDay  = date("Y-m-d", strtotime("today")+3600*24);

<?
    ...
    require_once $root . '/cms/cronJobs/db.class.php';
    require_once $root . '/cms/cronJobs/v4_OrderDetails.class.php';
    require_once $root . '/cms/cronJobs/v4_OrderDetailsFR.class.php';
    ...
    $where = " WHERE PickupDate >= '2018-04-01' ";

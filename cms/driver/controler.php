...
switch($activePage) {
	...
	case 'transfersList': 
        ...
        if($fakeDriverFound == true) require_once $modulesPath .'/transfers/transfersListFR.php'; 
		else require_once $modulesPath .'/transfers/transfersListN1.php'; 
		break;
	...
	case 'equipment':
		require_once $modulesPath . '/v4_Equipment/v4_Equipment.List.php';
		break;	 
	...
	case 'new_v4_Equipment':
		require_once $modulesPath . '/v4_Equipment/v4_EquipmentNew.php';
		break;	
	...
	// TIMETABLE TEST
	case 'timetableFormN':
		require_once $modulesPath . '/timetable/timetableFormN.php';
		break;

	case 'timetableN':
		require_once $modulesPath . '/timetable/timetableN.php';
		break;
	...
	case 'timetableColumnView':
		...
		break;
	// TIMETABLE TEST
	case 'timetableColumnViewN':
		require_once $modulesPath . '/timetable/timetableColumnViewN.php';
		break;
	...
	case 'subexpensesPre':
		require_once $modulesPath . '/v4_SubExpenses/v4_SubExpenses.List_Pre.php';
		break;
		
	case 'subactivities':
		require_once $modulesPath . '/v4_SubActivity/v4_SubActivity.List.php';
		break;
		
	case 'vehicleequipmentlist':
		require_once $modulesPath . '/v4_VehicleEquipmentList/v4_VehicleEquipmentList.List.php';
		break;
		
	case 'subactivityPre':
		require_once $modulesPath . '/v4_SubActivity/v4_SubActivity.List_Pre.php';
		break;
	...
	case 'new_v4_SubActivity':
		require_once $modulesPath . '/v4_SubActivity/v4_SubActivity.Edit.New.Driver.php';
		break;
		
	case 'new_v4_VehicleEquipmentList':
		require_once $modulesPath . '/v4_VehicleEquipmentList/v4_VehicleEquipmentList.Edit.New.Driver.php';
		break;		
	...
	case 'racun':
		require_once 'subdriver/racun.php'; 
		break;
	...
	case 'cd':
		require_once $modulesPath . '/reports/driver/cashDiff.php';
		break;

	case 'sdb':
		require_once $modulesPath . '/reports/driver/subDriverBalance.php';
		break;

	case 'sdbp':
		require_once $modulesPath . '/reports/driver/subDriverBalancePrior.php';
		break;
		
	case 'sdbT':
		require_once $modulesPath . '/reports/driver/subDriverBalanceT.php';
		break;
	// MISC
	case 'fileman':
	...
	case 'slct':
		require_once $modulesPath .'/selector/selectorLive.php';
		break;	
	case 'utls':
		require_once $modulesPath .'/../../fr/updateToLastState.php';
		break;
		
	case 'monthlyReport':
		require_once $modulesPath .'/selector/monthlyReport.php';
		break;

	case 'transfersReport':
		require_once $modulesPath .'/selector/transfersReport.php';
		break;	

	case 'dcN':
		require_once ROOT .'/cms/dcN.php';
		break;

...
function selectCountry(selected) {
    	...
    	var loading 	= '<img src="i/loading8.gif">';
		var selectActive 	= '';
...
function selectFrom(selected) {
    	...
    	$("#fromSelectorSpan").html(loading);
		//ReplaceSelectorText("#fromSelector", loading);

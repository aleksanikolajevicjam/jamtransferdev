	...
	Plugin.prototype =
	{
			...
			this.template = '<div class="dtp hidden" id="' + this.name + '">' +
								'<div class="dtp-content">' +
									...
									'<div class="dtp-buttons">' +
										'<button class="dtp-btn-now btn btn-blue hidden">' + this.params.nowText + '</button>' +
										'<button class="dtp-btn-clear btn btn-blue hidden">' + this.params.clearText + '</button>' +
										'<button class="dtp-btn-cancel btn btn-blue">' + this.params.cancelText + '</button>' +
										'<button class="dtp-btn-ok btn btn-blue">' + this.params.okText + '</button>' +
										'<div class="clearfix"></div>' +
									'</div>' +
								'</div>' +
							'</div>';
		...
		initHours: function()
		{
			...
			for(var i = 0; i < 12; i++)
			{
				...
				var fill = ((this.currentDate.format(hFormat) == i) ? "#d32f2f" : 'transparent');
			...
			if(!this.params.shortTime)
			{
				for(var i = 0; i < 12; i++)
				{
					...
					var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? "#d32f2f" : 'transparent');
		...
		initMinutes: function()
		{
			...
			for(var i = 0; i < 60; i++)
			{
				...
				var color = ((this.currentDate.format("m") == i) ? "#d32f2f" : 'transparent');
		...
		createSVGClock : function(isHour)
		{
			...
			if(isHour)
			{
				...
				var svgHourHand = this.createSVGElement("line", { class : 'hour-hand', x1 : 0, y1 : 0, x2 : 0, y2 : hl, stroke : '#d32f2f', 'stroke-width' : 8 });
			...
			{
				var svgMinuteHand = this.createSVGElement("line", { class : 'minute-hand', x1 : 0, y1 : 0, x2 : 0, y2 : -150, stroke : '#d32f2f', 'stroke-width' : 2 });
		...
		_onSelectHour: function(e)
		{
			if(!$(e.target).hasClass('disabled'))
			{
				...
				$(parent.find('#h-' + value)).attr('fill', '#d32f2f');
		...
		_onSelectMinute: function(e)
		{
			if(!$(e.target).hasClass('disabled'))
			{
				...
				$(parent.find('#m-' + value)).attr('fill', '#d32f2f');

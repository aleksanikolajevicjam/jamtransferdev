...
Class v4_SubDrivers {
     ...
     *
     */
	public function New_v4_SubDrivers($OwnerID,$DriverName,$DriverPassword,$DriverEmail,$DriverTel,$Notes,$Active){
	...
	public function getRow($key_row){
		$result = $this->connection->RunQuery("Select * from v4_SubDrivers where DriverID = \"$key_row\" ");
	...
	public function deleteRow($key_row){
		$this->connection->RunQuery("DELETE FROM v4_SubDrivers WHERE DriverID = $key_row");
	}
	...
	public function saveRow(){
		$result = $this->connection->RunQuery("UPDATE v4_SubDrivers set 
...
Active = '".$this->myreal_escape_string($this->Active)."' WHERE DriverID = '".$this->DriverID."'");
	return $result; 
}
	...
	public function getKeysBy($column, $order, $where = NULL){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT DriverID from v4_SubDrivers $where ORDER BY $column $order");
			while($row = $result->fetch_array(MYSQLI_ASSOC)){
				$keys[$i] = $row["DriverID"];
				$i++;
			}
	...
	public function fieldNames(){
		$fieldNames = array(
			'OwnerID',			'DriverID',			'DriverName',			'DriverPassword',			'DriverEmail',			'DriverTel',			'Notes',			'Active'		);
		return $fieldNames;
	}
    /**
     * Close mysql connection
     */
	public function endv4_SubDrivers(){

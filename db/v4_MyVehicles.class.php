...
Class v4_MyVehicles {
     ...
     *
     */
	public function New_v4_MyVehicles($OwnerID,$VehicleName,$VehicleTypeID,$SurCategory,$SurID,$PriceKm,$ReturnDiscount,$VehicleDescription,$VehicleCapacity,$VehicleImage,$VehicleImage2,$VehicleImage3,$VehicleImage4,$AirCondition,$ChildSeat,$Music,$TV,$GPS){
	...
	public function getRow($key_row){
		$result = $this->connection->RunQuery("Select * from v4_MyVehicles where VehicleID = \"$key_row\" ");
	...
	public function deleteRow($key_row){
		$this->connection->RunQuery("DELETE FROM v4_MyVehicles WHERE VehicleID = $key_row");
	}
	...
	public function saveRow(){
		$result = $this->connection->RunQuery("UPDATE v4_MyVehicles set 
...
GPS = '".$this->myreal_escape_string($this->GPS)."' WHERE VehicleID = '".$this->VehicleID."'");
	...
	public function getKeysBy($column, $order, $where = NULL){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT VehicleID from v4_MyVehicles $where ORDER BY $column $order");
			while($row = $result->fetch_array(MYSQLI_ASSOC)){
     ...
     */
	public function endv4_MyVehicles(){

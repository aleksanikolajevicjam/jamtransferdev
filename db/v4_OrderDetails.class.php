...
Class v4_OrderDetails {
	...
	public function getRow($key_row){
		$result = $this->connection->RunQuery("Select * from v4_OrderDetails where DetailsID = \"$key_row\" ");
	...
	public function deleteRow($key_row){
		$this->connection->RunQuery("DELETE FROM v4_OrderDetails WHERE DetailsID = $key_row");
	}
	...
	public function saveRow(){
		$result = $this->connection->RunQuery("UPDATE v4_OrderDetails set 
...
SubFinalNote = '".$this->myreal_escape_string($this->SubFinalNote)."' WHERE DetailsID = '".$this->DetailsID."'");
	...
	public function getKeysBy($column, $order, $where = NULL){
		$keys = array(); $i = 0;
		$result = $this->connection->RunQuery("SELECT DetailsID from v4_OrderDetails $where ORDER BY $column $order");
			while($row = $result->fetch_array(MYSQLI_ASSOC)){
